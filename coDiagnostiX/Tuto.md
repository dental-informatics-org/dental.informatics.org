...
We have organized a local folder structure with **sample data included** for you to start immediately. You can find these in the `dataset/` directory:

*   **[dataset/CBCT_Implant_Planning](./dataset/CBCT_Implant_Planning/)**: Contains 3D Cone Beam CT data (`.gipl` volumes).
*   **[dataset/Intraoral_Scans](./dataset/Intraoral_Scans/)**: Contains a `.stl` surface scan of a mandible.
*   **[dataset/Panoramic_Screening](./dataset/Panoramic_Screening/)**: Contains a sample panoramic X-ray (`.jpg`).

## 📖 Surgical Glossary & Terminology

### Anatomy
*   **Alveolar Ridge**: The bony ridge of the jaw that contains the tooth sockets.
*   **Mental Foramen**: The opening in the mandible (usually near premolars) where the mental nerve exits. **Critical Landmark**.
*   **Inferior Alveolar Nerve (IAN)**: The nerve running through the mandibular canal. Damage causes permanent numbness.
*   **Sinus Floor**: The bottom of the maxillary sinus. Implants must not perforate this without a sinus lift procedure.
*   **Cortical Bone**: The hard, dense outer layer of bone (D1/D2 density). Provides high stability.
*   **Trabecular Bone**: The spongy, porous inner bone (D3/D4 density). Less stable.

### Surgical Terms
*   **Osteotomy**: The surgical cutting or drilling of bone to prepare the site for the implant.
...
*   **Primary Stability**: The mechanical stability of the implant immediately after insertion. Measured in Newton-centimeters (Ncm). >35Ncm is often required for immediate loading.
*   **Flapless Surgery**: A minimally invasive technique where the implant is placed through the gum (using a tissue punch) without peeling back the soft tissue (flap). Requires a highly accurate surgical guide.
*   **Platform Switching**: A design concept where the abutment diameter is smaller than the implant platform, which helps preserve crestal bone levels.
...
### 3.2 Implant Selection Logic
**Why choose one implant over another?**

*   **Tapered Implants (e.g., Straumann BLX):**
    *   *Mechanism:* Wedges into bone like a screw.
    *   *Indication:* **Soft Bone (D3/D4)** or **Immediate Placement**.
    *   *Benefit:* High primary stability (condenses bone).
*   **Parallel-Walled Implants:**
    *   *Mechanism:* Passive fit.
    *   *Indication:* **Hard Bone (D1/D2)** (Mandible).
    *   *Benefit:* Reduces risk of pressure necrosis (bone death from overheating/compression).
*   **Tissue Level vs. Bone Level:**
    *   **Bone Level (BL):** Entire implant is submerged. Best for **Aesthetics** (Anterior).
    *   **Tissue Level (TL):** Polished collar sits above bone. Best for **Posterior** (Healthier for gums, easier hygiene).

### 3.3 Virtual Placement Steps
1.  **Library:** Choose from the **Integrated Library**.
